...
with st.expander('Getting started'):
    st.markdown("""#### Example""")
    data1_link = 'test' #utils.generate_downloadlink(resources.test_file1, text='data set 1')
    data2_link = 'test' #utils.generate_downloadlink(resources.test_file2, text='data set 2')
